 ...
 * @author Admin
 */
public class auditTransactions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Audit Transactions");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(auditTransactions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new auditTransactions().setVisible(true);
            }
        });
    }
