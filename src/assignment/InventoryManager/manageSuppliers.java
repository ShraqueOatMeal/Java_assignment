...
public class manageSuppliers extends javax.swing.JFrame {
  ...
  private void loadTable() {
    ...
    DefaultTableModel model = new DefaultTableModel(
        new Object[][] {},
        new String[] { "Supplier ID", "Supplier Name", "Address", "Supplier Item ID", "Price" }) {
      boolean[] canEdit = new boolean[] {
  ...
  private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton7ActionPerformed
    ...
    addressField = new javax.swing.JTextField(15);
    priceField = new javax.swing.JTextField(15);
    ...
    buttonUpdate.addActionListener(e -> {
      try {
        ...
        if (inventoryManager.addSupplier(supplierID, supplierName, supplierItemID, address, price)) {
          dialog.dispose();
          loadTable();
        }
      } catch (Exception ex) {
  ...
  public void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    String supplierItemID = (String) jTable1.getValueAt(selectedRow, 3);
    ...
    JLabel addressLabel = new JLabel("Address:");
    JTextField editAddressField = new JTextField(address);
    JLabel priceLabel = new JLabel("Price:");
    JTextField editPriceField = new JTextField(price);
    ...
    editDialog.add(editAddressField);
    ...
    submitButton.addActionListener(e -> {
      ...
      if (inventoryManager.updateSupplier(newSupplierID, newSupplierName, newSupplierItemID)) {
        ...
        model.setValueAt(newSupplierItemID, selectedRow, 3);
        model.setValueAt(newPrice, selectedRow, 4);
