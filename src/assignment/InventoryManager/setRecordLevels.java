 ...
 * @author Admin
 */
public class setRecordLevels extends javax.swing.JFrame {

    /**
     * Creates new form setRecordLevels
     */
    public setRecordLevels() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Set Reorder Levels");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(setRecordLevels.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new setRecordLevels().setVisible(true);
            }
        });
    }
