...
import assignment.PurchaseManager.createPurchaseOrder;

/**
 *
 * @author Admin
 */
public class createSuccess extends javax.swing.JFrame {

  /**
   * Creates new form createSuccess
   */
  ...
  private void initComponents() {
    ...
    jLabel1.setText("Your creation was successful and send to manager!");
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(createSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new createSuccess().setVisible(true);
      }
    });
  }
